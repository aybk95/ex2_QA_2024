...
public class AppTest {
	...
	Task2 TriangleClassifier = new Task2();
/**
 * Rigorous Test :-)
 */
...
//	assertEquals => ensures the output matches the expected value.
	...
	@Test
    public void testTC1() {
        assertEquals("Real roots", tester.classifyRoots(5, 6, 6)); // Failures
//        assertEquals("Real roots", tester.classifyRoots(5, 18, 12)); // Its without failures
    }
